...
class SendDataTab(QWidget):
    def __init__(self):
        ...
        indicators_group_box_layout.addWidget(QLabel("R value (V)"),0,0,1,1)
        indicators_group_box_layout.addWidget(QLabel("Theta value (Deg.)"),0,1,1,1)
        indicators_group_box_layout.addWidget(QLabel("Curr. Frequency (Hz)"),0,2,1,1)
        indicators_group_box_layout.addWidget(self.r_value,1,0,1,1)
        indicators_group_box_layout.addWidget(self.theta_value,1,1,1,1)
        indicators_group_box_layout.addWidget(self.curr_f,1,2,1,1)
        indicators_group_box_layout.addWidget(QLabel("Resonance Frequency (Hz)"),2,0,1,1)
        # indicators_group_box_layout.addWidget(QLabel("Current Voltage (V)"),2,1,1,1)
        indicators_group_box_layout.addWidget(QLabel("Max. Amplitude (mV)"),2,1,1,1)
        indicators_group_box_layout.addWidget(self.resonance_f,3,0,1,1)
        # indicators_group_box_layout.addWidget(self.curr_v,3,1,1,1)
        indicators_group_box_layout.addWidget(self.max_amp,3,1,1,1)
